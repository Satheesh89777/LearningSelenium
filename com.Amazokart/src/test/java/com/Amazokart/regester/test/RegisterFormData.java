...
public class RegisterFormData extends BaseClass_Register {
	//clear the data in name text filed
	@Test
	...
	public void sendData() throws Throwable
	{
		...
		driver.findElement(By.cssSelector("input[id='email']")).sendKeys("sathish123@gmail.com");

		// Enter value into the password TextFiled
		driver.findElement(By.xpath("//input[@placeholder='Enter your Password']")).sendKeys("sathish@123");
